...
The `DataverseQuery` library includes a C# source generator that analyzes your query builder usage and automatically generates strongly-typed result classes. This provides:
...
// The source generator creates a result type based on your selections
// Use anonymous types or define your own result classes
...
3. **Result types are generated** in the `DataverseQuery.Generated` namespace
4. **Use `.To()`** with a projection lambda to create the mapper
5. **Execute and map** your query results with full type safety

The source generator creates result classes with properties matching exactly what you selected in your query, ensuring compile-time safety and IntelliSense support throughout your codebase.
